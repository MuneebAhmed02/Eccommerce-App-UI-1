...
class Gphones extends StatefulWidget {
  const Gphones({Key? key}) : super(key: key);

  @override
  _GphonesState createState() => _GphonesState();
}

class _GphonesState extends State<Gphones> {
  @override
